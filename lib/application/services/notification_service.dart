...
Future<void> init() async {
  ...
  final notificationAppLaunchDetails = !kIsWeb &&
          Platform.isLinux
      ? null
...
class _HomePageState extends State<HomePage> {
                  ...
                  if (!kIsWeb && Platform.isLinux) ...<Widget>[
                    ...
                    Builder(
                      builder: (BuildContext context) => PaddedElevatedButton(
                        ...
                        onPressed: () async {
                          final path = _linuxIconPathController.text;
                          if (path.isEmpty) {
  ...
  Future<void> _showNotificationCustomSound() async {
    ...
    final linuxPlatformChannelSpecifics =
        LinuxNotificationDetails(
  ...
  Future<void> _showGroupedNotifications() async {
    ...
    const firstNotificationAndroidSpecifics =
    ...
    const secondNotificationAndroidSpecifics =
        AndroidNotificationDetails(groupChannelId, groupChannelName,
            channelDescription: groupChannelDescription,
            importance: Importance.max,
            priority: Priority.high,
  ...
  Future<Widget> _getActiveNotificationsDialogContent() async {
    if (Platform.isAndroid) {
      ...
      if (fullVersion.isNotEmpty) {
        final version = int.tryParse(fullVersion[0]);
